...
public abstract class Utils {
	 ...
	 */
	public static void showErrorBox(CySwingApplication desktopApp,String aTitle, String aMessage) {
		showErrorBox(desktopApp.getJFrame(), aTitle, aMessage);
	}
	...
	public static class MenuPaneHyperlinkListener implements HyperlinkListener {
		...
		public void hyperlinkUpdate(HyperlinkEvent e) {
			if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
                                OpenBrowser openBrowser = ServiceController.getInstance().getAdapter().getCyServiceRegistrar().getService(OpenBrowser.class);
